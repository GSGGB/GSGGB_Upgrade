...
export const SENIOR_STAFF = [
    ...
    {name: "Farbod Khorrami",
     image: require("./static/headshots/farbod.jpg"),
     position: "Co-President",
     ...
     firstname: "Farbod",
     linkedin: "https:://www.linkedin.com",
     email: "farbod.khorrami@mail.utoronto.ca",
     id: "farbodk"
    },
    {name: "Emma Sullivan",
     image: require("./static/headshots/emma.jpg"),
     ...
     firstname:"Emma",
     linkedin: "https://www.linkedin.com/in/emmagsullivan/",
     email: "emma.sullivan@mail.utoronto.ca",
     id: "emmas"
    }
]
...
export const CONFERENCE = [
    {name: "Lucie Perillat",
     image: require("./static/headshots/lucie.jpg"),
     ...
     firstname: "Lucie",
     linkedin: "https://www.linkedin.com/in/lucieperillat/",
     email: "lucie.perillat@mail.utoronto.ca",
     id: "luciep"
    },
    {name: "Decaran Li",
     image: require("./static/headshots/decaran.jpg"),
     position: "Conference Committee Co-Leader",
     ...
     firstname: "Decaran",
     linkedin: "https://www.linkedin.com/in/decaran-li-880a8415b/",
     email: "decaran.li@mail.utoronto.ca",
     id: "decaranl"
    },
    {name: "Nitya Gulati",
     image: require("./static/headshots/nitya.jpg"),
     ...
     firstname: "Nitya",
     linkedin: "https://www.linkedin.com/in/nitya-gulati-a1a327157/",
     email: "nitya.gulati@mail.utoronto.ca",
     id: "nityag"
    },
    {name: "Niharikaa Aiyar",
     image: require("./static/headshots/niharikaa.jpg"),
     ...
     firstname: "Niharikaa",
     linkedin: "https://www.linkedin.com/in/niharikaa-aiyar-428329157/",
     email: "niharikaa.aiyar@mail.utoronto.ca",
     id: "niharikaaa"
    },
    {name: "Areeb Rashid Jafrani",
     image: require("./static/headshots/areeb.jpg"),
     ...
     firstname:"Areeb",
     linkedin: "https:://www.linkedin.com",
     email: "areeb.jafrani@mail.utoronto.ca",
     id: "areebj"
     },
     {name: "Raissa Shrestha",
      image: require("./static/headshots/raissa.jpg"),
      position: "Event Coordinator",
      ...
      firstname:"Raissa",
      linkedin: "https://www.linkedin.com/in/raissa-s/",
      email: "raissa.shrestha@mail.utoronto.ca",
      id: "raissas"
      },
      {name: "Sasha Bourdine",
       image: require("./static/headshots/sasha.jpg"),
       ...
       firstname:"Sasha",
       linkedin: "https:://www.linkedin.com",
       email: "sasha.bourdine@mail.utoronto.ca",
       id: "sashab"
      }
]
...
export const MARKETING = [
  {name: "Samantha Chan",
   image: require("./static/headshots/samantha.jpg"),
   ...
   firstname: "Samantha",
   linkedin: "https://www.linkedin.com/in/samanthachan23/",
   email: "saman.chan@mail.utoronto.ca",
   id: "samanthac"
  },
  {name: "Yiyue (January) Jiang",
   image: require("./static/headshots/january.jpg"),
   ...
   firstname: "January",
   linkedin: "https://www.linkedin.com/in/yiyue-january-jiang/",
   email: "yiyue.jiang@mail.utoronto.ca",
   id: "januaryj"
  },
  {name: "Ada Huang",
   image: require("./static/headshots/ada.jpg"),
   position: "Graphic Designer",
   ...
   firstname: "Ada",
   linkedin: "https:://www.linkedin.com",
   email: "ada.huang@mail.utoronto.ca",
   id: "adah"
  },
  {name: "Padraig Greene",
   image: require("./static/headshots/paddy.jpg"),
   position: "1st Year Representative",
   biography: "To come.",
   firstname: "Paddy",
   linkedin: "https://www.linkedin.com/in/padraig-greene-04b6a4173/",
   email: "paddy.greene@mail.utoronto.ca",
   id: "paddyg"
  },
  {name: "Jenny Liu",
   image: require("./static/headshots/jennyl.jpg"),
   position: "Social Media Coordinator",
   ...
   firstname:" Jenny",
   linkedin: "https://www.linkedin.com/in/jenny-l-0887761bb/",
   email: "jennyj.liu@mail.utoronto.ca",
   id: "jennyl"
   }
]
...
export const AFFAIRS = [
    {name: "Irisjade Ong",
     image: require("./static/headshots/irisjade.jpg"),
     ...
     firstname: "Irisjade",
     linkedin: "https://www.linkedin.com/in/irisjade-ong-793914197/",
     email: "irisjade.ong@mail.utoronto.ca",
     id: "irisjadeo"
    },
    {name: "Jenny Huang",
     image: require("./static/headshots/jennyh.jpg"),
     ...
     firstname: "Jenny",
     linkedin: "https://www.linkedin.com/in/jia-hui-jenny-huang-782191153/",
     email: "jenny.huang@mail.utoronto.ca",
     id: "jennyh"
    },
    {name: "Jocelyn Tan",
     image: require("./static/headshots/jocelyn.jpg"),
     position: "Affairs Executive",
     ...
     firstname: "Jocelyn",
     linkedin: "https:://www.linkedin.com",
     email: "jocelyn.tan@mail.utoronto.ca",
     id: "jocelynt"
    }
]
...
export const MENTORSHIP = [
    {name: "Ronesh Sukhdeo",
     image: require("./static/headshots/ronesh.jpg"),
     ...
     firstname: "Ronesh",
     linkedin: "https://www.linkedin.com/in/ronesh-s-070b49139/",
     email: "ronesh.sukhdeo@mail.utoronto.ca",
     id: "roneshs"
    },
    {name: "Lina Li",
     image: require("./static/headshots/lina.jpg"),
     ...
     firstname: "Lina",
     linkedin: "https:://www.linkedin.com",
     email: "linali.li@mail.utoronto.ca",
     id: "linal"
    },
    {name: "Gabrielle Lim",
     image: require("./static/headshots/gabrielle.jpg"),
     position: "Mentorship Associate",
...
export const EVENTS = [
    {name: "Jacky Chen",
     image: require("./static/headshots/jacky.jpg"),
     ...
     firstname: "Jacky",
     linkedin: "https://www.linkedin.com/in/jackyhungkaichen/",
     email: "jackykai.chen@mail.utoronto.ca",
     id: "jackyc"
    },
    {name: "Sakshi Shinghal",
     image: require("./static/headshots/sakshi.jpg"),
     ...
     firstname: "Sakshi",
     linkedin: "https://www.linkedin.com/in/sdshinghal/",
     email: "sdshinghal@gmail.com",
     id: "sakshis"
    },
    {name: "Setareh Malekian",
     image: require("./static/headshots/setareh.jpg"),
     ...
     firstname: "Setareh",
     linkedin: "https://www.linkedin.com/in/setareh-malekian-naeini-b1ab7216a/",
     email: "setareh.malekian@mail.utoronto.ca",
     id: "setarehm"
    }
]
...
export const TECH_INNOVATIONS = [
    {name: "Jedid Ahn",
     image: require("./static/headshots/jedid.jpg"),
     ...
     firstname: "Jed",
     linkedin: "https://www.linkedin.com/in/jedid-ahn/",
     email: "jedid.ahn@mail.utoronto.ca",
     id: "jeda"
    },
    {name: "Justin Cheung",
     image: require("./static/headshots/justin.jpg"),
     ...
     firstname: "Justin",
     linkedin: "https://www.linkedin.com/in/justin-cheung-a94100157/",
     email: "kaihim.cheung@mail.utoronto.ca",
     id: "justinc"
    },
    {name: "Advait Sridhar",
     image: require("./static/headshots/advait.jpg"),
     ...
     firstname: "Advait",
     linkedin: "https://www.linkedin.com/in/advait-sridhar-72a22a174/",
     email: "advait.sridhar@mail.utoronto.ca",
     id: "advaits"
    }
]
...
export const ALUMNI = [
    {name: "Robert Koucheki",
     image: require("./static/headshots/robert.jpg"),
     position: "Co Founder",
     biography: "Robert Koucheki is the co-founder of the Global Society for Genetics and Genome Biology. He is pursuing a combined MD and Master of Biomedical Engineering at The University of Toronto. He is an aspiring orthopedic surgeon-scientist and has extensive research experience in diverse fields. Robert is currently involved with numerous research projects in the Orthopaedic Surgery Departments at Mount Sinai Hospital and the Hospital for Sick Children, as well as the Materials Engineering Department at the University of Toronto. Robert is a big believer in personalized medicine and bringing bench to the bedside. He aims to combine his expertise in basic science, genetic research, and biomedical engineering, with his passion for orthopaedic surgery, to find novel solutions for patients suffering from various musculoskeletal conditions.",
     firstname: "Robert",
     linkedin: "https://www.linkedin.com/in/robert-koucheki/",
     email: "bob.kouchekivarnosfaderani@mail.utoronto.ca",
     id: "robertk"
    },
    {name: "Lazar Joksimovic",
     image: require("./static/headshots/lazar.jpg"),
     position: "Co Founder",
     biography: "Lazar Joksimovic recently graduated from the University of Toronto (St. George Campus). He triple majored in Physiology, Immunology, and Molecular Genetics & Microbiology. After volunteering with children affected by debilitating rare genetic conditions, he was motivated to spread awareness and push the field forward towards finding cures for these fatal illnesses. Lazar is an aspiring physician-scientist who has devoted his undergraduate years to investigating the biology of genetically-mediated diseases. His research projects range from characterizing oncogenic drivers of tumorigenesis in rare hereditary cancer syndromes in Dr. Uri Tabori’s laboratory, to deciphering the molecular mechanisms of over 40 neurodegenerative and neuromuscular diseases in Dr. Christopher Pearson’s laboratory. He will be pursuing MD-PhD training in the United States, where he hopes to continue pushing the boundaries of our understanding of genetically mediated diseases. If you share the same passions as Lazar, please feel free to apply for a position in GSGGB’s executive team 😊. He enjoys working with a multi-disciplinary team of science enthusiasts!",
     firstname: "Lazar",
     linkedin: "https://www.linkedin.com/in/lazar-joksimovic-0167b2152/",
     email: "lazar.joksimovic@mail.utoronto.ca",
     id: "lazarj"
    },
    {name: "Sahar Alimirzaie",
     image: require("./static/headshots/sahar.jpg"),
     position: "Organization President",
     biography: "Sahar Alimirzaie is one of the Co-Presidents of the Global Society for Genetics and Genome Biology, University of Toronto Chapter. Prior to moving to Canada, she studied 2 years of medicine at Shahid Beheshti University of Medical Sciences. She is currently an immunology specialist and physiology major at the University of Toronto. She is also a research student in Dr.Mohammad Akbari’s laboratory at the Women’s College Hospital. Her previous project was on novel pancreatic cancer driver genes. Currently, she is studying applications of liquid biopsy in breast cancer. She has achieved the highest mark in class in many of her courses and has won many national and international awards.",
     firstname: "Sahar",
     linkedin: "https://www.linkedin.com/in/sarah-mirzaie-sahar-alimirzaie-431890150/",
     email: "sahar.alimirzaie@mail.utoronto.ca",
     id: "sahara"
    },
]
