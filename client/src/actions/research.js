...
const addResearchPostHelper = async(homepageComp, researchPost) => {
    ...
    const userURL = "/.netlify/functions/api/userDatabase/" + researchPost.userId;
...
export const getAllResearchPosts = (homepageComp) => {
    const url = "/.netlify/functions/api/researchDatabase";
...
export const getResearchPostById = (researchComp, id) => {
    const url = "/.netlify/functions/api/researchDatabase/" + id;
