...
const deleteImageHelper = async(sponsor) => {
      const imageURL = "/.netlify/functions/api/imageDatabase/" + sponsor.imageId;
...
const addSponsorHelper = async(sponsorsComp, sponsor) => {
    ...
    const userURL = "/.netlify/functions/api/userDatabase/" + sponsor.userId;
...
export const getAllSponsors = (sponsorsComp) => {
    const url = "/.netlify/functions/api/sponsorDatabase";
...
export const getSponsorById = (singleSponsorComp, id) => {
    const url = "/.netlify/functions/api/sponsorDatabase/" + id;
...
export const editSponsor = (singleSponsorComp, sponsorsComp, imageCloudinaryId, sponsorId) => {
    const url = "/.netlify/functions/api/sponsorDatabase/" + sponsorId;
