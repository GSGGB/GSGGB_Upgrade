...
const deleteImageHelper = async(gEvent) => {
      const imageURL = "/.netlify/functions/api/imageDatabase/" + gEvent.imageId;
...
const addEventHelper = async(eventsComp, gEvent, dateToday) => {
    ...
    const userURL = "/.netlify/functions/api/userDatabase/" + gEvent.userId;
...
export const getAllEvents = (eventsComp) => {
    const url = "/.netlify/functions/api/eventDatabase";
...
export const getEventById = (singleEventComp, id) => {
    const url = "/.netlify/functions/api/eventDatabase/" + id;
...
export const editEvent = (singleEventComp, eventsComp, imageCloudinaryId, eventId) => {
    const url = "/.netlify/functions/api/eventDatabase/" + eventId;
